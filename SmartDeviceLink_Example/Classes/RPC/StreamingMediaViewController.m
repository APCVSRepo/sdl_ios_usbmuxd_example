...
- (void)viewDidLoad {
    ...
    segLabel.frame = CGRectMake(20, 64 + 20, CGRectGetWidth(self.view.frame) - 20 - 20, 30);
    segLabel.text = @"视频质量：";
    [_contentView addSubview:segLabel];
    
    _segmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"低", @"中", @"高"]];
    _segmentedControl.frame = CGRectMake(CGRectGetMinX(segLabel.frame), CGRectGetMaxY(segLabel.frame), CGRectGetWidth(segLabel.frame), 30);
